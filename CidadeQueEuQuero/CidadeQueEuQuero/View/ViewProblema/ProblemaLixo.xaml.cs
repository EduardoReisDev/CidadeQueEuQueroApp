...
namespace CidadeQueEuQuero.View.ViewProblema
{
    ...
    public partial class ProblemaLixo : ContentPage
    {
        ProblemaLixoVM problemaLixoVM;

        public ProblemaLixo()
        {
            InitializeComponent();
            problemaLixoVM = new ProblemaLixoVM();
            BindingContext = problemaLixoVM;
            GeoLoc();
        }
