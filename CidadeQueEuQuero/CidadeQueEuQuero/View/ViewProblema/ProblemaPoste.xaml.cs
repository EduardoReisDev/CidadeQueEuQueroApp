...
namespace CidadeQueEuQuero.View.ViewProblema
{
    ...
    public partial class ProblemaPoste : ContentPage
    {
        ProblemaPosteVM problemaPosteVM;

        public ProblemaPoste()
        {
            InitializeComponent();
            problemaPosteVM = new ProblemaPosteVM();
            BindingContext = problemaPosteVM;
            GeoLoc();
        }
        ...
        public async void GeoLoc()
        {
            try
            {
                ...
                if (location != null)
                {
                    ...
                    Pin pin = new Pin
                    {
                        Label = "Poste de luz com problemas",
                        Type = PinType.Place,
