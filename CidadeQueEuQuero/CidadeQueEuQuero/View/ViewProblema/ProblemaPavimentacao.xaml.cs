...
namespace CidadeQueEuQuero.View.ViewProblema
{
    ...
    public partial class ProblemaPavimentacao : ContentPage
    {
        ProblemaPavimentacaoVM problemaPavimentacaoVM;

        public ProblemaPavimentacao()
        {
            InitializeComponent();
            problemaPavimentacaoVM = new ProblemaPavimentacaoVM();
            BindingContext = problemaPavimentacaoVM;
            GeoLoc();
        }
