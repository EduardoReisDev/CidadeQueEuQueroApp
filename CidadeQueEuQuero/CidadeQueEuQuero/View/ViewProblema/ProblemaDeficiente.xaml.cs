...
namespace CidadeQueEuQuero.View.ViewProblema
{
    ...
    public partial class ProblemaDeficiente : ContentPage
    {
        ProblemaDeficienteVM problemaDeficienteVM;

        public ProblemaDeficiente()
        {
            InitializeComponent();
            problemaDeficienteVM = new ProblemaDeficienteVM();
            BindingContext = problemaDeficienteVM;
            GeoLoc();
        }
        ...
        public async void GeoLoc()
        {
            try
            {
                ...
                if (location != null)
                {
                    ...
                    Pin pin = new Pin
                    {
                        Label = "Calçada sem acesso para deficientes",
                        Type = PinType.Place,
