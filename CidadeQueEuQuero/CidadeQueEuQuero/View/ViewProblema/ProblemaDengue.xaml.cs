...
namespace CidadeQueEuQuero.View.ViewProblema
{
    ...
    public partial class ProblemaDengue : ContentPage
    {
        ProblemaDengueVM problemaDengueVM;

        public ProblemaDengue()
        {
            InitializeComponent();
            problemaDengueVM = new ProblemaDengueVM();
            BindingContext = problemaDengueVM;
            GeoLoc();
        }
